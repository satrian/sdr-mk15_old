/*
This calculator is originating from https://github.com/Lampus/cdce913

Written by Lapin Roman <lampus.lapin(6)gmail.com>

Header from the main part of the driver file sais:
*/
...
union pll_conf find_coeffs(unsigned int fvco, unsigned int* fvcoreal)
{
	...
	unsigned int real_fvco, br_q, br_r, n, m, min_n=0, min_m=0, err;
